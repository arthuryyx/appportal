    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h3>Role Management</h3></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        @foreach($permissions as $id => $label)
                                            <label>{{ Form::checkbox('permission[]', $id, false, array('class' => 'name checkbox-inline')) }}
                                                {{ $label }}
                                            </label>
                                            &nbsp;
                                        @endforeach
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ url('admin/role/'.$role->id.'/edit') }}" class="btn btn-success">编辑</a></td>
                                    <td>
