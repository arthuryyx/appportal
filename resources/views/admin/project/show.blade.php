    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                {{ Form::hidden('assign_to', $project->id) }}
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                ...
                <tbody>
                @foreach ($project->hasManyAppliances as $stock)
                    <tr>
                        {{--<td>{{ $stock->total }}</td>--}}
                        ...
                        <td>
                            @if($stock->state == 0)
                                ...
                                {{--<button type="button" class="btn btn-success">asd</button>--}}
