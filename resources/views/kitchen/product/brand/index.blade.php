                ...
                <div class="panel-body">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="container-fluid">
                            {!! Form::open(['url' => 'kitchen/product/brand','method'=>'POST']) !!}
                            <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach ($table as $brand)
                                <tr>
                                    <td>{{ $brand->name }}</td>
                                    <td class="text-center"><a href="{{ url('kitchen/product/brand/'.$brand->id.'/edit') }}" class="btn btn-success">编辑</a></td>
                                    {{--<td>--}}
