        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <a href="{{ url('kitchen/job/quote/'.$quote->id.'/edit') }}" class="btn btn-success">Edit</a>
...
{{--                                <td>{{date('d/M/Y', strtotime('-1 Month', strtotime($quote->created_at)))}}</td>--}}
                    ...
                    <hr>
                    <div class="col-lg-4">
                        {!! Form::open(['url' => 'kitchen/product/item','method'=>'POST']) !!}
                        <div class="row">
                            <div class="col-xs-10 col-sm-10 col-md-10">
                                <strong>Appliance</strong>
                                <select class="template_id form-control" name="template_id" required="required"></select>
                                {{--<strong>Price</strong>--}}
...
@section('js')
    ...
    <script type="text/javascript">
        $('.template_id').select2({
            theme: "bootstrap",
            ajax: {
                url: '/select2-autocomplete-ajax/kitchen/template',
                dataType: 'json',
                delay: 500,
            ...
            .on('select2:select', function (e) {
                $.ajax({
                    url: '/kitchen/product/template/' + e.params.data.id,
                    method: 'GET',
