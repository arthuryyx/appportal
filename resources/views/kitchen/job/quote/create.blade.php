...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">New Quote</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                    {!! Form::open(['url' => 'kitchen/job/quote','method'=>'POST', 'id'=>'form']) !!}
                        <div class="row">

                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Region:</strong>
                                    {{ Form::select('code', $regions, null, ['class' => 'form-control', 'placeholder'=>'', 'required' => 'required']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('address', null, array('id' => 'autocomplete', 'class' => 'form-control')) !!}
                                </div>
                            </div>
