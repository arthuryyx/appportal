            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        {!! Form::model($quote, ['method' => 'PATCH','route' => ['kitchen.quote.update', $quote->id]]) !!}
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>quote_no:</strong>
                                        {!! Form::text('quote_no', null, array('class' => 'form-control', 'disabled' => 'disabled')) !!}
                                    </div>
                                </div>
